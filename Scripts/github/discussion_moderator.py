...
def github_request(
    ...
    headers = {
        ...
        "User-Agent": "forsetti-framework-windows-discussion-moderation",
    }
...
def ensure_alert_issue(
    ...
    issue = create_issue(
        ...
        (
            ...
            "This issue is maintained by the automated discussion moderation responder.\n"
...
def main() -> int:
    ...
    graphql_url = discussion_router.derive_graphql_url(api_base_url)
    if not token:
